...
<template>
  <div class="flex flex-col items-center gap-10 max-lg:gap-6!">
    ...
    <div
      v-if="ready"
      class="w-full max-w-2xl overflow-hidden rounded-[20px] border border-(--border-gray) bg-(--background)"
    >
    ...
    <UButton size="xl" color="primary" to="/comparo" class="rounded-full" style="color: white">
