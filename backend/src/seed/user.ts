  ...
  await User.insertMany([
    {
      ...
      lastname: 'Dupont',
      pseudo: 'AliceD',
      email: 'alice.dupont@perforum.com',
      password:
    ...
    },
    {
      ...
      lastname: 'Bernard',
      pseudo: 'ClaraB',
      email: 'clara.bernard@perforum.com',
      password:
    ...
    },
    {
      ...
      lastname: 'Leroy',
      pseudo: 'DavidL',
      email: 'david.leroy@perforum.com',
      password:
